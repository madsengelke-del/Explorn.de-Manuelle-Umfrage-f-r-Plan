  ...
  return (
    <main className={styles.wrap}>
      ...
      <div className={styles.card}>
        ...
        <h1 className={styles.title}>Antworten erhalten!</h1>
        <p className={styles.text}>Danke — ich habe deine Angaben bekommen und melde mich in den nächsten Tagen mit deinem persönlichen Reiseplan.</p>
